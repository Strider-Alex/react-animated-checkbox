      ...
      >
        {state =>(
          <label 
            ...
            style={{ ...this.GetCheckBoxStyle(), borderColor: state.borderColor }}
          >
            <div style={{ ...this.GetBeforeStyle(), height: state.beforeHeight }} />
            <div style={{ ...this.GetAfterStyle(), height: state.afterHeight }} />
          </label>
        )}
      </Animate>
    );
